...
public class ItemDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = getIntent().getStringExtra(ItemDetailFragment.PLANET_NAME);
        ArrayList<String> films = getIntent().getStringArrayListExtra(ItemDetailFragment.FILMS_LIST);
